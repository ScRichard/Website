...
const Hero = () => {
    return (
        <div className="flex flex-row max-[700px]:flex-col items-center justify-center gap-12 p-4 transition-colors duration-300">
            ...
            <div className="flex flex-col gap-1 max-[700px]:items-center">
                <h1 className="font-roboto-mono font-bold text-3xl text-gray-900">Richard Schmidt</h1>
